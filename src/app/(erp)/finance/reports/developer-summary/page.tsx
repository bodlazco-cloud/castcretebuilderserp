...
export default function DeveloperSummaryReportPage() {
  return (
    <main style={{ padding: "2rem", background: "#f9fafb", minHeight: "100vh", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ maxWidth: "1100px" }}>
        ...
        <p style={{ margin: "0 0 2rem", color: "#6b7280", fontSize: "0.9rem", paddingLeft: "1.25rem" }}>
          Per-developer billing summary: units turned over, amounts billed, collections received, and outstanding receivables.
        </p>
        <div style={{ background: "#fff", borderRadius: "8px", boxShadow: "0 1px 4px rgba(0,0,0,0.07)", padding: "3rem", textAlign: "center" }}>
          ...
          <p style={{ color: "#9ca3af", fontSize: "0.85rem", maxWidth: "480px", margin: "0 auto" }}>
            The Developer Summary will show billings issued per developer client against the Architectural Turnover milestone, collections received, and ageing of outstanding receivables — supporting the Completed Contract revenue recognition method.
          </p>
        </div>
      </div>
    </main>
