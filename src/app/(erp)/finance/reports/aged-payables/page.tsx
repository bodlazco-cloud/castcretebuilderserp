    ...
    <main style={{ padding: "2rem", background: "#f9fafb", minHeight: "100vh", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ maxWidth: "1100px" }}>
        ...
        <p style={{ margin: "0 0 2rem", color: "#6b7280", fontSize: "0.9rem", paddingLeft: "1.25rem" }}>
          Outstanding payables bucketed by age: 0–30, 31–60, 61–90, and 90+ days — for cash flow management and vendor relationship oversight.
        </p>
        <div style={{ background: "#fff", borderRadius: "8px", boxShadow: "0 1px 4px rgba(0,0,0,0.07)", padding: "3rem", textAlign: "center" }}>
          ...
          <p style={{ color: "#9ca3af", fontSize: "0.85rem", maxWidth: "480px", margin: "0 auto" }}>
            The Aged Payables report will bucket all outstanding supplier invoices and subcon billings by payment age, flagging overdue items and projecting cash requirements for the next 30/60/90 days — exportable for BOD cash flow review.
          </p>
        </div>
      </div>
    </main>
