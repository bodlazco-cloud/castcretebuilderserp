    ...
    <main style={{ padding: "2rem", background: "#f9fafb", minHeight: "100vh", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ maxWidth: "1100px" }}>
        <div style={{ marginBottom: "1.5rem" }}>
          <a href="/motorpool" style={{ fontSize: "0.8rem", color: ACCENT, textDecoration: "none" }}>
            ← Fleet (Motorpool)
          </a>
        </div>
        ...
        <p style={{ margin: "0 0 2rem", color: "#6b7280", fontSize: "0.9rem", paddingLeft: "1.25rem" }}>
          Scheduled and corrective maintenance logs per equipment unit — feeds Fix-or-Flip ROI analysis.
        </p>
        <div style={{ background: "#fff", borderRadius: "8px", boxShadow: "0 1px 4px rgba(0,0,0,0.07)", padding: "3rem", textAlign: "center" }}>
          ...
          <p style={{ color: "#9ca3af", fontSize: "0.85rem", maxWidth: "480px", margin: "0 auto" }}>
            Maintenance records will track parts cost, labour time, and downtime per equipment unit. These costs are factored into the Fleet Fix-or-Flip ROI calculator to determine whether an asset should be retained or disposed of.
          </p>
        </div>
      </div>
    </main>
