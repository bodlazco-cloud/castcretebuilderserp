...
import { updateDeveloper } from "@/actions/master-list";
...
export function EditDeveloperForm({ developer }: { developer: { id: string; name: string } }) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await updateDeveloper(developer.id, { name });
