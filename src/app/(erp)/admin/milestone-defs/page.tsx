    ...
    <main style={{ padding: "2rem", background: "#f9fafb", minHeight: "100vh", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ maxWidth: "1100px" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", marginBottom: "1.5rem" }}>
          ...
          <a href="/admin/milestone-defs/new" style={{
        ...
        {rows.length === 0 ? (
          <div style={{ padding: "3rem", background: "#fff", borderRadius: "8px", boxShadow: "0 1px 4px rgba(0,0,0,0.07)", textAlign: "center", color: "#9ca3af" }}>
            No milestone definitions yet. <a href="/admin/milestone-defs/new" style={{ color: ACCENT }}>Add first milestone →</a>
          </div>
        ) : (
                  ...
                  {rows.map((r) => (
                    <tr key={r.id} style={{ borderBottom: "1px solid #f3f4f6", opacity: r.isActive ? 1 : 0.5 }}>
                      ...
                      <td style={{ padding: "0.65rem 1rem", textAlign: "right" }}>
                        <a href={`/admin/milestone-defs/${r.id}`} style={{ color: ACCENT, textDecoration: "none", fontSize: "0.8rem", fontWeight: 600 }}>Edit →</a>
                      </td>
                    </tr>
                  ))}
                </tbody>
