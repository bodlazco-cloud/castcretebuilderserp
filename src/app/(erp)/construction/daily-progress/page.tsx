  ...
  return (
    <main style={{ padding: "2rem", background: "#f9fafb", minHeight: "100vh", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ maxWidth: "960px" }}>
        ...
        <h1 style={{ margin: "0 0 0.4rem", fontSize: "1.5rem", fontWeight: 700, color: "#111827" }}>Daily Progress</h1>
        <p style={{ margin: 0, color: "#6b7280", fontSize: "0.9rem" }}>View and filter daily progress logs across all sites.</p>
