...
const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Progress Tracking",     isGroup: true },
      ...
      { label: "WARs",                  isGroup: true },
      { label: "Submit WAR",            href: "/construction/submit-war" },
      { label: "WAR Records",           href: "/construction/war" },
      { label: "Architectural Turnover", href: "/construction/architectural-turnover" },
      { label: "Reports",               isDivider: true },
