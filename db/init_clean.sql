...
CREATE TABLE IF NOT EXISTS "fix_or_flip_assessments" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"equipment_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS "fleet_internal_billing" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"equipment_id" uuid NOT NULL,
	"project_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS "developer_advance_tracker" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"project_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS "batching_manpower_logs" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"log_date" date NOT NULL,
	"employee_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS "fleet_manpower_logs" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"log_date" date NOT NULL,
	"employee_id" uuid NOT NULL,
	"equipment_id" uuid,
...
CREATE TABLE IF NOT EXISTS "turnover_certificates" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"unit_id" uuid NOT NULL,
	"turnover_date" date NOT NULL,
	"status" varchar(20) DEFAULT 'DRAFT' NOT NULL,
